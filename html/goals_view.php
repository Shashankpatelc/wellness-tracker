...
<body>
    ...
    <div class="container scale-in delay-200">
        <section class="add-goal-form fade-in-up">
            ...
            <?php endif; ?>
            <form action="/wellness-tracker/php/goals.php" method="post">
                <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!$goal['is_completed']): ?>
                                        <a href="/wellness-tracker/php/goals.php?action=complete&goal_id=<?php echo $goal['goal_id']; ?>" class="button">Complete</a>
                                    <?php endif; ?>
                                    <a href="/wellness-tracker/php/goals.php?action=delete&goal_id=<?php echo $goal['goal_id']; ?>" class="button">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
