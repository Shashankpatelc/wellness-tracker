...
<body>
    <div class="header">
        ...
        <div class="auth-buttons">
            <a href="/wellness-tracker/php/help.php" class="button primary">Quick Support</a>
            <a href="/wellness-tracker/php/goals.php" class="button primary">My Goals</a>
            <a href="/wellness-tracker/php/summary.php" class="button primary">Summary</a>
            <a href="/wellness-tracker/php/ai_chat.php" class="button primary">AI Chat</a>
            <a href="/wellness-tracker/php/export.php" class="button">Export to CSV</a>
            ...
            <div class="profile-dropdown">
                ...
                <div class="profile-dropdown-menu" id="profileDropdownMenu">
                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                        <a href="/wellness-tracker/php/admin/dashboard.php">
    ...
    <div class="container">
        ...
        <section class="tracking-form">
            ...
            <form action="/wellness-tracker/php/dashboard.php" method="post">
